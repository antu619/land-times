...
const NewsCard = ({ singleNews }) => {
    const { title, image_url, details, _id, author, rating, total_view } = singleNews;
    return (
        <div className='border-2 rounded'>
            <div className='flex justify-between items-center px-5 py-3 bg-base-300'>
                ...
                <div className='flex gap-2'>
                    <Link><img className='w-5' src={saveIcon} alt="" /></Link>
                    <Link><IoShareSocialOutline className='text-xl' /></Link>
                </div>
            </div>
            <div className='p-5'>
                ...
                <div className='flex justify-between'>
                    <div className="rating">
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-cyan-600" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-cyan-600" checked />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-cyan-600" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-cyan-600" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-cyan-600" />
